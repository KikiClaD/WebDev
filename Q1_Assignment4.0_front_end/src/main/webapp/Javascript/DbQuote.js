...
$(document).ready(function() {
    ...
    function handleErrors(response){
		/*If there is an error*/
        if (!response.ok) {
            throw new Error('The quote number is already used or you do not have the rights to complete this form');
        }
        /*If there is no error, we save the data in a .txt file*/	
	 		...
	 		let info = 
                ...
                const sFileName = 'Quote.txt';      // The file to save the data.
                ...
                newLink.click(); 
           		...
           		h1.textContent = "Hello " + $('#surname').val() + " " + $('#firstname').val() + " your quote has been created"
		}
        return response;
    }
});
